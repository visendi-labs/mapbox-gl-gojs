...
[Full code](https://github.com/visendi-labs/mapbox-gl-gojs/tree/main/docs/example7) (run with `go run main.go` from the `golang` folder)
...
[filename](/example7/common/map.go ':include :type=code :fragment=demo')
